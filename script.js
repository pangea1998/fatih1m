document.addEventListener('DOMContentLoaded', function() {
    ...
    function redirectToIyzico(amount) {
        ...
        // Shopier ödeme sayfası URL'si (kullanıcı tarafından daha sonra sağlanacak)
        // Bu kısım kullanıcı tarafından sağlanacak gerçek Shopier ödeme linki ile değiştirilecek
        const shopierUrl = '#'; // Kullanıcı tarafından sağlanacak
